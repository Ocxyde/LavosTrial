...
namespace Code.Lavos.Core
{
    ...
    private void SetupEnvironment()
    {
        ...
        // Disable GI for performance and to prevent light bleeding through walls
        UnityEngine.Rendering.GraphicsSettings.defaultRenderPipeline?.SetLightingSettings(null);
