...
namespace Code.Lavos
{
    ...
    /// </summary>
    public class ItemPlacerEngine : MonoBehaviour
    {
        ...
        public void PlaceAllItems()
        {
            ...
            {
                Debug.LogError("[ItemPlacerEngine] MazeGenerator not found!");
                return;
            }

            ClearAllItems();

            Debug.Log("[ItemPlacerEngine] Starting item placement...");
            ...
            Debug.Log($"[ItemPlacerEngine] Placement complete! Total: {_placedItems.Count} items");
        }
        ...
        private DoubleDoor PlaceDoorAtCell(Vector2Int cell, DoorType type, float luminance)
        {
            ...
            Debug.Log($"[ItemPlacerEngine] Placed {type} door at {cell}");
            return door;
        }
        ...
        private ChestBehavior PlaceChestAtCell(Vector2Int cell)
        {
            ...
            Debug.Log($"[ItemPlacerEngine] Placed chest at {cell}");
            return chest;
        }
        ...
        public void PlacePickups()
        {
            ...
            {
                Debug.LogWarning("[ItemPlacerEngine] No pickup prefabs assigned!");
                return;
            }
        ...
        public void ClearAllItems()
        {
            ...
            _placedItems.Clear();
            Debug.Log("[ItemPlacerEngine] All items cleared");
        }
