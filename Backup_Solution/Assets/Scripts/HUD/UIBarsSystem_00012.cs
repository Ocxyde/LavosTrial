...
namespace Unity6.LavosTrial.HUD
{
    ...
    public class UIBarsSystem : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                Core.EventHandler.Instance.OnPlayerHealthChanged += SetHealth;
                Core.EventHandler.Instance.OnPlayerManaChanged += SetMana;
                Core.EventHandler.Instance.OnPlayerStaminaChanged += SetStamina;
