...
namespace Code.Lavos.HUD
{
    ...
    public class HUDSystem : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Debug.Log("[HUDSystem] Initialized - Ready to plug into EventHandler");
        }
        ...
        private void Start()
        {
            ...
            Debug.Log("[HUDSystem] All systems plugged in and operational");
        }
        ...
        private Image CreateBar(GameObject parent, string name, Color color, float thickness, float length, bool vertical)
        {
            ...
            fillImage.fillOrigin = vertical ? (int)Image.FillOrigin.Bottom : (int)Image.FillOrigin.Left;
        ...
        private void CreateStatusEffectsPanel()
        {
            ...
            // Content container for effect icons (vertical layout)
            _effectsContent = _statusEffectsRoot.transform;
        ...
        private void SubscribeToEvents()
        {
            ...
            {
                Debug.LogWarning("[HUDSystem] EventHandler not found - HUD will not update dynamically");
                return;
            }
        ...
        private void UnsubscribeFromEvents()
        {
            ...
            Debug.Log("[HUDSystem] Unplugged from EventHandler - All events unsubscribed");
        }
        ...
        {
            // Handle custom stat changes if needed
            Debug.Log($"[HUDSystem] Stat changed: {statName} = {newValue}");
        }
        ...
        public void AddStatusEffect(StatusEffectData effectData, float duration, int stacks = 1)
        {
            ...
            Debug.Log($"[HUDSystem] Status effect added: {effectData.effectName}");
        }
        ...
        public void RemoveStatusEffect(string effectName)
        {
            if (_activeEffects.ContainsKey(effectName))
            {
                ...
                Debug.Log($"[HUDSystem] Status effect removed: {effectName}");
            }
        }
