...
namespace Code.Lavos.HUD
{
    ...
    public class HUDSystem : MonoBehaviour
    {
        ...
        private void CreateBars()
        {
            ...
            Debug.Log("[HUDSystem] Creating bars...");
            ...
            healthGO.transform.SetParent(_hudRoot.transform, false);
            var healthRect = healthGO.AddComponent<RectTransform>();
            healthRect.anchorMin = new Vector2(0f, 0.15f);
            healthRect.anchorMax = new Vector2(0f, 0.85f);
            healthRect.pivot = new Vector2(0f, 0.5f);
            healthRect.anchoredPosition = new Vector2(20, 0);
            healthRect.sizeDelta = new Vector2(25f, 0f);

            // Background (on healthGO)
            var healthBG = healthGO.AddComponent<Image>();
            healthBG.color = new Color(0.1f, 0.1f, 0.1f, 0.9f);

            // Fill bar (CHILD of healthGO - separate GameObject!)
            var healthFillGO = new GameObject("HealthFill");
            healthFillGO.transform.SetParent(healthGO.transform, false);
            ...
            _healthBarFill = healthFillGO.AddComponent<Image>();
            if (_healthBarFill != null)
            {
                ...
                Debug.Log("[HUDSystem] Health bar created: " + (_healthBarFill != null));
            }
            ...
            manaGO.transform.SetParent(_hudRoot.transform, false);
            ...
            manaRect.anchoredPosition = new Vector2(-20, 0);
            manaRect.sizeDelta = new Vector2(25f, 0f);

            // Background (on manaGO)
            var manaBG = manaGO.AddComponent<Image>();
            manaBG.color = new Color(0.1f, 0.1f, 0.1f, 0.9f);

            // Fill bar (CHILD of manaGO - separate GameObject!)
            var manaFillGO = new GameObject("ManaFill");
            manaFillGO.transform.SetParent(manaGO.transform, false);
            var manaFillRect = manaFillGO.AddComponent<RectTransform>();
            manaFillRect.anchorMin = Vector2.zero;
            manaFillRect.anchorMax = Vector2.one;
            manaFillRect.sizeDelta = Vector2.zero;
            
            _manaBarFill = manaFillGO.AddComponent<Image>();
            if (_manaBarFill != null)
            {
                ...
                Debug.Log("[HUDSystem] Mana bar created: " + (_manaBarFill != null));
            }
            ...
            staminaGO.transform.SetParent(_hudRoot.transform, false);
            var staminaRect = staminaGO.AddComponent<RectTransform>();
            staminaRect.anchorMin = new Vector2(0.15f, 0f);
            staminaRect.anchorMax = new Vector2(0.85f, 0f);
            staminaRect.pivot = new Vector2(0.5f, 0f);
            staminaRect.anchoredPosition = new Vector2(0, 20);
            staminaRect.sizeDelta = new Vector2(0f, 25f);

            // Background (on staminaGO)
            var staminaBG = staminaGO.AddComponent<Image>();
            staminaBG.color = new Color(0.1f, 0.1f, 0.1f, 0.9f);

            // Fill bar (CHILD of staminaGO - separate GameObject!)
            var staminaFillGO = new GameObject("StaminaFill");
            staminaFillGO.transform.SetParent(staminaGO.transform, false);
            var staminaFillRect = staminaFillGO.AddComponent<RectTransform>();
            staminaFillRect.anchorMin = Vector2.zero;
            staminaFillRect.anchorMax = Vector2.one;
            staminaFillRect.sizeDelta = Vector2.zero;
            
            _staminaBarFill = staminaFillGO.AddComponent<Image>();
            if (_staminaBarFill != null)
            {
                ...
                Debug.Log("[HUDSystem] Stamina bar created: " + (_staminaBarFill != null));
            }

            if (_staminaText == null)
                _staminaText = CreateOverlayText(staminaGO, "StaminaText", "100/100");

            Debug.Log("[HUDSystem] All bars created successfully!");
