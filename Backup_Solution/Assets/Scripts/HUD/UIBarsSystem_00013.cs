...
namespace Unity6.LavosTrial.HUD
{
    ...
    public class UIBarsSystem : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                EventHandler.Instance.OnPlayerHealthChanged += SetHealth;
                EventHandler.Instance.OnPlayerManaChanged += SetMana;
                EventHandler.Instance.OnPlayerStaminaChanged += SetStamina;
