...
namespace Code.Lavos.HUD
{
    ...
    public class HUDSystem : MonoBehaviour
    {
        ...
        private void CreateBars()
        {
            ...
            healthRect.sizeDelta = new Vector2(25f, -200f); // 25px wide, 200px from top/bottom
            
            var healthBG = healthGO.AddComponent<Image>();
            healthBG.color = new Color(0.1f, 0.1f, 0.1f, 0.8f);
            ...
            _healthBarFill.fillOrigin = 0; // Bottom for vertical fill
            ...
            _manaBarFill.fillOrigin = 0; // Bottom for vertical fill
            ...
            staminaRect.anchorMax = new Vector2(1f, 0f);
            staminaRect.pivot = new Vector2(0.5f, 0f);
            staminaRect.anchoredPosition = new Vector2(0, 20);
            staminaRect.sizeDelta = new Vector2(-400, 25f);

            var staminaBG = staminaGO.AddComponent<Image>();
            staminaBG.color = new Color(0.1f, 0.1f, 0.1f, 0.8f);
            ...
            _staminaBarFill.fillOrigin = 0; // Left for horizontal fill
