...
// - ItemBehavior (base class in Core/Base/)
//   ├── DoubleDoor
//   ├── ChestBehavior
//   ├── ItemPickup
//   ├── SwitchBehavior
...
namespace Code.Lavos.Core
{
    ...
    /// All items plug into this system via ItemBehavior base class.
    /// </summary>
    public class ItemEngine : MonoBehaviour
    {
        ...
        /// <summary>
        /// Register an item with the engine (called automatically by ItemBehavior.Awake).
        /// </summary>
        ...
        /// <summary>
        /// Unregister an item from the engine (called automatically by ItemBehavior.OnDestroy).
        /// </summary>
