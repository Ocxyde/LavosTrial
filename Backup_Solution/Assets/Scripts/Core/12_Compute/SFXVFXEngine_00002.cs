// SFXVFXEngine.cs
// ⚠️ DEPRECATED - USE AudioManager.cs INSTEAD ⚠️
// Unity 6 compatible - UTF-8 encoding - Unix line endings
//
// 🚫 DO NOT USE FOR NEW DEVELOPMENT 🚫
// This class is deprecated. Use AudioManager.cs for all audio needs.
//
// AudioManager provides:
// - Professional audio pooling
// - Better architecture
// - More features
//
...
{
    /// <summary>
    /// ⚠️ DEPRECATED - Use AudioManager instead.
    /// 
    /// Legacy SFX/VFX engine. Redundant with AudioManager.
    /// Self-creates singleton (plug-in-out violation).
    /// </summary>
    [System.Obsolete("Use AudioManager for all audio. This class is deprecated.")]
        ...
        public static SFXVFXEngine Instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    if (_instance == null)
                    {
                        // ⚠️ DEPRECATED: Self-creation is a plug-in-out violation
