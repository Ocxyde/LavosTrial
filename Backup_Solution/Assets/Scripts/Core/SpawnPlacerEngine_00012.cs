...
namespace Code.Lavos.Core
{
    ...
    public class SpawnPlacerEngine : MonoBehaviour
    {
        ...
        [SerializeField] private bool requireMazeGenerator = true;  // Reserved for validation
        
        [Header("Door Settings")]
        [SerializeField] private DoorType startDoorType = DoorType.Start;  // Reserved for future use
