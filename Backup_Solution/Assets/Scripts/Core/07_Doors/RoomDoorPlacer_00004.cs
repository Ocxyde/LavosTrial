...
namespace Code.Lavos.Core
{
    ...
    public class RoomDoorPlacer : MonoBehaviour
    {
        ...
        private void FindComponents()
        {
            ...
            if (holePlacer == null)
                Debug.LogWarning("[RoomDoorPlacer] ⚠️ DoorHolePlacer not found in scene (add independently)");
            
            if (gridMazeGenerator == null)
                Debug.LogWarning("[RoomDoorPlacer] ⚠️ GridMazeGenerator not found in scene (add independently)");
        }
