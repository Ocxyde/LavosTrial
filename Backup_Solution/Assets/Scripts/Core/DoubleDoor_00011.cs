...
namespace Code.Lavos.Core
{
    ...
    public class DoubleDoor : BehaviorEngine
    {
        ...
        // Note: openSpeed and closeSpeed reserved for future animation system
        ...
        private void CreateDoorPanel(Transform parent, string name, Vector3 pos, Quaternion rot, Material mat, Vector2 size)
        {
            ...
            if (collider == null)
            {
                collider = panel.AddComponent<BoxCollider>();
            }
        ...
        public void Open()
        {
            ...
            if (doorRoot != null)
            {
                ...
                if (leftPanel != null)
                {
                    ...
                    // Disable collider when open to prevent blocking
                    var leftCollider = leftPanel.GetComponent<Collider>();
                ...
                if (rightPanel != null)
                {
                    ...
                    // Disable collider when open to prevent blocking
                    var rightCollider = rightPanel.GetComponent<Collider>();
