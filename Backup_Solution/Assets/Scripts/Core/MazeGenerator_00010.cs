...
namespace Code.Lavos.Core
{
    ...
    [SerializeField] private bool useSeedManager = true;  // Plug-in-out: Use SeedManager
    ...
    {
        // Plug-in-out: Use SeedManager if enabled
        if (useSeedManager && SeedManager.Instance != null)
        {
