// MazeRenderer.cs
// DEPRECATED: Legacy maze rendering system
// Unity 6 compatible - UTF-8 encoding - Unix line endings
//
// ⚠️ DEPRECATED - DO NOT USE FOR NEW MAZE GENERATION ⚠️
// This class is kept for backward compatibility only.
// 
// USE CompleteMazeBuilder.cs FOR ALL MAZE GENERATION:
// - CompleteMazeBuilder handles ground, walls, objects
...
// Suppress obsolete warnings - this file intentionally uses legacy systems
...
namespace Code.Lavos.Core
{
    ...
    {
    [Header("⚠️ DEPRECATED - Use CompleteMazeBuilder instead")]
    ...
    [Header("Ambiance")]
    [SerializeField] private Color ambientColor = new Color(0.25f, 0.2f, 0.15f);
    ...
    [Header("Exit Door")]
    [SerializeField] private bool spawnExitDoor = false;
    ...
    void Awake()
    {
        Debug.LogWarning("[MazeRenderer] ⚠️ DEPRECATED: Use CompleteMazeBuilder for maze generation!");
    ...
    void Start()
    {
        Debug.LogWarning("[MazeRenderer] ⚠️ DEPRECATED: Add CompleteMazeBuilder component instead!");
        ...
        {
            Debug.Log("[MazeRenderer] No MazeIntegration found - auto-building maze (DEPRECATED)");
            BuildMaze();
        }
        else
        {
    ...
    /// <summary>
    /// ⚠️ DEPRECATED - Use CompleteMazeBuilder.GenerateMaze() instead.
    /// This method is kept for backward compatibility only.
    /// </summary>
    public void BuildMaze()
    {
        Debug.LogWarning("[MazeRenderer] BuildMaze() called - DEPRECATED! Use CompleteMazeBuilder instead.");
