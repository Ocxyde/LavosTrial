...
namespace Code.Lavos.Core
{
    ...
    public class GameConfig
    {
        ...
        public string doorMaterial = "Materials/Door_PïxelArt.mat";
        ...
        public float defaultDoorChance = 0.6f;
        ...
        private static GameConfig CreateDefault()
        {
            return new GameConfig
            {
                ...
                doorMaterial = "Materials/Door_PïxelArt.mat",
