    ...
    public class MazeTorchTest : MonoBehaviour
    {
        ...
        private void SpawnGroundPlane()
        {
            ...
            if (ground == null)
            {
                ...
                Log("[MazeTorchTest] Ground plane created at y=0 (200x200m)");
            }
        }
        ...
        private void SpawnTestPlayer()
        {
            ...
            // Maze is 21x21 cells, so middle is at cell (10, 10)
            // Cell size is 6m, so middle = (10 * 6, 1, 10 * 6) = (60, 1, 60)
            float cellSize = 6f;
            int middleCell = mazeWidth / 2; // Cell 10 for 21-wide maze
            float spawnX = middleCell * cellSize;
            float spawnZ = middleCell * cellSize;
            float spawnY = 1f; // On ground plane
            ...
            Log($"[MazeTorchTest] Player spawned at {_testPlayer.transform.position} (MIDDLE of maze - cell {middleCell},{middleCell})");
