...
namespace Code.Lavos.Core
{
    ...
    public class GridMazeGenerator
    {
        ...
        private void ExpandIntersectionsToChambers()
        {
            ...
            // Collect all valid intersections first (4-way only for proper connectivity)
            ...
            foreach (Vector2Int intersection in intersections)
            {
                ...
                // 30% chance to expand intersection to chamber (more walls for proper maze)
            ...
            if (chambersCreated < 3)
            {
                ...
                // Fallback: find corridor cells and create chambers from them
                if (chambersCreated < 3)
                {
                    Debug.Log($"[GridMazeGenerator] No intersections found - creating chambers from corridor cells");
                    ...
                    // Shuffle and pick cells spaced apart
                    ...
                    foreach (Vector2Int cell in corridorCells)
                    {
                        ...
                        // Check if not too close to existing chambers
                        bool tooClose = false;
