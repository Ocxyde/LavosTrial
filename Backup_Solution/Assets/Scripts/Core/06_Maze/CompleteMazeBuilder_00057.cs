...
namespace Code.Lavos.Core
{
    ...
    public class CompleteMazeBuilder : MonoBehaviour
    {
        ...
        private void RenderWalls()
        {
            ...
            // Initialize renderer with grid data
            mazeRenderer.Initialize(grid, mazeSize, seed, currentLevel);

            // Set renderer properties from CompleteMazeBuilder
            // (using reflection or direct access if made public)
            // For now, we'll call the render method directly
