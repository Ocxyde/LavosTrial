...
namespace Code.Lavos.Core
{
    ...
    public class GridMazeGenerator
    {
        ...
        // Divisor for target cell calculation (carves ~25% of grid for better coverage)
        private const int TARGET_CELL_DIVISOR = 4;
        ...
        private void ExpandIntersectionsToChambers()
        {
            ...
            foreach (Vector2Int intersection in intersections)
            {
                ...
                // 50% chance to expand intersection to chamber
