...
namespace Code.Lavos.Core
{
    ...
    public class GridMazeGenerator
    {
        ...
        private float seedFactor = 0.5f; // 0.0 = easy, 1.0 = hard
        ...
        public void Generate(uint seed, float difficultyFactor = 0.5f)
        {
        ...
        private void PlaceOtherRooms()
        {
            ...
            // Scale room count by difficulty factor (1-3 base + 0-5 bonus = 1-8 rooms)
            int baseRooms = Random.Range(1, 4);
            int bonusRooms = Mathf.FloorToInt(seedFactor * 5f); // 0-5 bonus rooms
