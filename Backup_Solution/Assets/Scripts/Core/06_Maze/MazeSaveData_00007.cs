...
namespace Code.Lavos.Core
{
    ...
    public static class MazeSaveData
    {
        ...
        /// </summary>
        public static void SaveGridMaze(int seed, byte[] gridData, int spawnX, int spawnZ, string seedString = null)
        {
            Initialize();
            ...
            // Also store string seed for proper restoration
            if (!string.IsNullOrEmpty(seedString))
            {
                PlayerPrefs.SetString("GridDB_SeedString", seedString);
            }
        ...
        /// <summary>
        /// Load saved seed string from database.
        /// Returns null if no save exists.
        /// </summary>
        public static string LoadSeedString()
        {
            Initialize();

            if (PlayerPrefs.HasKey("GridDB_SeedString"))
            {
                string seedString = PlayerPrefs.GetString("GridDB_SeedString");
                Debug.Log($"[MazeSaveData]  Loaded seed string: {seedString}");
                return seedString;
            }
        ...
        public static void ClearGridMazeData()
        {
            ...
            PlayerPrefs.DeleteKey("GridDB_SeedString");
            PlayerPrefs.Save();
