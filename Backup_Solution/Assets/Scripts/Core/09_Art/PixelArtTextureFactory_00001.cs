...
// Procedural pixel-art texture generator for dungeon walls, floors, ceilings, and torch flames
// Unity 6 compatible - UTF-8 encoding - Unix line endings
//
// ART: Generates cached pixel art textures for reuse
...
namespace Code.Lavos.Core
{
    ...
    /// Part of the Art system - texture caching and generation.
    /// </summary>
    public static class PixelArtTextureFactory
    {
        ...
        public static void ClearCache()
        {
            ...
            if (_flameFrames != null)
            {
                for (int i = 0; i < _flameFrames.Length; i++) DestroyTexture(ref _flameFrames[i]);
                _flameFrames = null;
            }
        }
