...
namespace Code.Lavos.Core
{
    ...
    public class TorchPool : MonoBehaviour
    {
                                   ...
                                   Material flameMat, Material handleMat)
        {
            ...
            // IMPORTANT: Set parent FIRST, then reset local transform, then set world position
            ...
            // Don't call TurnOn here - already called after InitializeBrasero
            // Torch is now ready and lit!
        ...
        public void ReleaseAll()
        {
            foreach (var ctrl in _active)
            {
                ...
                // Reset transform and return to pool
                go.SetActive(false);
