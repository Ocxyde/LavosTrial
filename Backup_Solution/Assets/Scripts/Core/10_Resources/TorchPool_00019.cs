...
namespace Code.Lavos.Core
{
    ...
    public class TorchPool : MonoBehaviour
    {
                                   ...
                                   Material flameMat, Material handleMat)
        {
            ...
            Debug.Log($"[TorchPool] Torch added to pool - Total active: {_instances.Count}");
            return ctrl;
        }
        ...
        {
            Debug.Log($"[TorchPool] ReleaseAll called - {_instances.Count} instances to destroy");
            ...
            Debug.Log($"[TorchPool] ReleaseAll complete");
        }
