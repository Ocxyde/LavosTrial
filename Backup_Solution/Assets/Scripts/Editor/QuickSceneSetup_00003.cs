...
namespace Code.Lavos.Editor
{
    ...
    public class QuickSceneSetup
    {
        ...
        private static void AddCoreComponents(GameObject mazeTest)
        {
            ...
            // Core maze components - use full type names
            ...
            Debug.Log("  ✅ Added 11 components");
        }

        private static void AddComponentIfMissing(GameObject go, string typeName)
        {
        ...
        private static void ConfigureComponents(GameObject mazeTest)
        {
            ...
            {
                SetField(mazeIntegration, "autoGenerateOnStart", true);
