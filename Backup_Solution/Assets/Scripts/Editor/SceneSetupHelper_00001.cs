...
namespace Code.Lavos.Editor
{
    ...
    public class SceneSetupHelper : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            DrawStatusItem("HUDEngine", CheckHUDEngine(), "Modular HUD system");
        ...
        private bool CheckHUDEngine() => FindFirstObjectByType<HUDEngine>() != null;
        ...
        private void VerifySceneSetup()
        {
            ...
            LogStatus("HUDEngine", CheckHUDEngine(), ref missing);
        ...
        private void SetupCanvas()
        {
            ...
            canvasComp.renderMode = RenderMode.ScreenSpace - Overlay;
        ...
        private void SetupHUDSystems()
        {
            ...
            if (!CheckHUDEngine())
            {
                var hudEngine = new GameObject("HUDEngine");
                hudEngine.AddComponent<HUDEngine>();
                Debug.Log("✅ Added HUDEngine");
            }
            else
            {
                Debug.Log("✅ HUDEngine already exists");
            }
        }
