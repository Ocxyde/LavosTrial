...
namespace Code.Lavos.Editor
{
    ...
    public class MazeBuilderEditor : EditorWindow
    {
        ...
        public static void GenerateMaze()
        {
            ...
            Debug.Log($"  📏 Maze Size: {mazeBuilder.CurrentMazeSize}x{mazeBuilder.CurrentMazeSize}");
        ...
        public static void NextLevel()
        {
            ...
            if (mazeBuilder != null)
            {
                ...
                Debug.Log($"[MazeBuilderEditor] 🎮 Advanced to Level {mazeBuilder.CurrentLevel} - Maze {mazeBuilder.CurrentMazeSize}x{mazeBuilder.CurrentMazeSize}");
            }
            else
            {
