...
namespace Code.Lavos.Editor
{
    ...
    public class SceneSetupHelper : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            DrawStatusItem("HUDSystem", CheckHUDSystem(), "Complete dynamic HUD (NEW)");
        ...
        private void SetupUI()
        {
            ...
            // Add UIBarsSystem (legacy - kept for compatibility)
            if (!CheckUIBars())
            {
                var uiBars = new GameObject("UIBarsSystem");
                uiBars.AddComponent<UIBarsSystem>();
                Debug.Log("✅ Added UIBarsSystem (legacy)");
            }
            else
            {
            ...
            // Add HUDSystem (NEW - Complete dynamic HUD)
            if (!CheckHUDSystem())
            {
            ...
            // Note: Use HUDSystem for complete HUD functionality
            // UIBarsSystem is kept for legacy compatibility only
        }
