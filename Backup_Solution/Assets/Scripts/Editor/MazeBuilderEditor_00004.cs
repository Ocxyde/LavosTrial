    ...
    public class MazeBuilderEditor : EditorWindow
    {
        ...
        public static void GenerateMaze()
        {
            ...
            if (mazeBuilder == null)
            {
                ...
                Debug.LogError("[MazeBuilderEditor] 💡 PLUG-IN-OUT: Add CompleteMazeBuilder component to a GameObject in the scene");
                Debug.LogError("[MazeBuilderEditor] 💡 Required components: CompleteMazeBuilder, MazeGenerator, MazeRenderer, SpatialPlacer, LightPlacementEngine, TorchPool");
                return;
            }
