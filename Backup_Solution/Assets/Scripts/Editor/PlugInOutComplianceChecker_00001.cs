...
namespace Code.Lavos.Editor
{
    ...
    public class PlugInOutComplianceChecker : EditorWindow
    {
        ...
        private void ScanCompliance()
        {
            ...
            // Summary
            int errors = violations.Count(v => !v.isWarning);
            int warnings = violations.Count(v => v.isWarning);
        ...
        private void OnGUI()
        {
            ...
            {
                GUILayout.Label($"Found {violations.Count} violations:", EditorStyles.boldLabel);
