...
namespace Code.Lavos.Editor
{
    ...
    public class QuickSceneSetup : MonoBehaviour
    {
        ...
        private static void AddCoreComponents(GameObject mazeTest)
        {
            ...
            if (mazeTest.GetComponent<Code.Lavos.Core.MazeGenerator>() == null)
                mazeTest.AddComponent<Code.Lavos.Core.MazeGenerator>();

            if (mazeTest.GetComponent<Code.Lavos.Core.MazeRenderer>() == null)
                mazeTest.AddComponent<Code.Lavos.Core.MazeRenderer>();

            if (mazeTest.GetComponent<Code.Lavos.Core.MazeIntegration>() == null)
                mazeTest.AddComponent<Code.Lavos.Core.MazeIntegration>();

            if (mazeTest.GetComponent<Code.Lavos.Core.SpatialPlacer>() == null)
                mazeTest.AddComponent<Code.Lavos.Core.SpatialPlacer>();

            if (mazeTest.GetComponent<Code.Lavos.Core.TorchPool>() == null)
                mazeTest.AddComponent<Code.Lavos.Core.TorchPool>();

            // Lighting components
            if (mazeTest.GetComponent<Code.Lavos.Core.LightPlacementEngine>() == null)
                mazeTest.AddComponent<Code.Lavos.Core.LightPlacementEngine>();

            if (mazeTest.GetComponent<Code.Lavos.Core.LightEngine>() == null)
                mazeTest.AddComponent<Code.Lavos.Core.LightEngine>();

            // Environment components
            if (mazeTest.GetComponent<Code.Lavos.Core.GroundPlaneGenerator>() == null)
                mazeTest.AddComponent<Code.Lavos.Core.GroundPlaneGenerator>();

            if (mazeTest.GetComponent<Code.Lavos.Core.CeilingGenerator>() == null)
                mazeTest.AddComponent<Code.Lavos.Core.CeilingGenerator>();

            // Test controller
            if (mazeTest.GetComponent<Code.Lavos.Core.FpsMazeTest>() == null)
                mazeTest.AddComponent<Code.Lavos.Core.FpsMazeTest>();
        ...
        private static void ConfigureComponents(GameObject mazeTest)
        {
            ...
            var mazeGenerator = mazeTest.GetComponent<Code.Lavos.Core.MazeGenerator>();
            ...
            var mazeRenderer = mazeTest.GetComponent<Code.Lavos.Core.MazeRenderer>();
            ...
            var mazeIntegration = mazeTest.GetComponent<Code.Lavos.Core.MazeIntegration>();
            ...
            SetField(mazeIntegration, "spatialPlacer", mazeTest.GetComponent<Code.Lavos.Core.SpatialPlacer>());
            Debug.Log("  • MazeIntegration: Rooms=3-8, Doors=60%, Level=1");

            // Configure SpatialPlacer
            var spatialPlacer = mazeTest.GetComponent<Code.Lavos.Core.SpatialPlacer>();
            ...
            SetField(spatialPlacer, "torchPool", mazeTest.GetComponent<Code.Lavos.Core.TorchPool>());
            SetField(spatialPlacer, "lightPlacementEngine", mazeTest.GetComponent<Code.Lavos.Core.LightPlacementEngine>());
            Debug.Log("  • SpatialPlacer: Torches=60, Chests=5, Enemies=8, Items=10");

            // Configure TorchPool
            var torchPool = mazeTest.GetComponent<Code.Lavos.Core.TorchPool>();
            ...
            var lightPlacementEngine = mazeTest.GetComponent<Code.Lavos.Core.LightPlacementEngine>();
            ...
            var lightEngine = mazeTest.GetComponent<Code.Lavos.Core.LightEngine>();
            ...
            var fpsMazeTest = mazeTest.GetComponent<Code.Lavos.Core.FpsMazeTest>();
