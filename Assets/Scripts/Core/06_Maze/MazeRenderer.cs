...
// ║  Wall rendering is now handled directly by CompleteMazeBuilder║
// ║  in the SpawnAllWalls() and SpawnWallIfPresent() methods.     ║
// ║                                                               ║
// ║  REASON: Duplicate functionality - CompleteMazeBuilder has    ║
// ║  its own wall spawning system that is actively used.          ║
// ║                                                               ║
...
namespace Code.Lavos.Core
{
    ...
    /// DEPRECATED: Use CompleteMazeBuilder.SpawnAllWalls() instead.
    /// </summary>
