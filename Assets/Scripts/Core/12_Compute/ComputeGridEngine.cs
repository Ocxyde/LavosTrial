...
namespace Code.Lavos.Core
{
    ...
    public class ComputeGridEngine : MonoBehaviour
    {
        ...
        #region Event Subscription (Plug-in-Out Architecture)

        /// <summary>
        /// Subscribe to compute grid events via EventHandler.
        /// This is the plug-in-out way - events find us, we don't call directly.
        /// </summary>
        private void SubscribeToEvents()
        {
            ...
            {
                Debug.LogWarning("[ComputeGridEngine] EventHandler not found - events will not work");
            }
        }
        ...
        /// <summary>
        /// Handle save request from EventHandler.
        /// </summary>
        ...
        /// <summary>
        /// Handle load request from EventHandler.
        /// </summary>
        private void HandleLoadRequested(string mazeId, int seed)
        {
            Debug.Log($"[ComputeGridEngine] Load requested via event: {mazeId}");
            SetMazeId(mazeId);
            SetMazeSeed(seed);
            LoadFromBinary();
        }
        ...
        /// <summary>
        /// Handle cell set request from EventHandler.
        /// </summary>
        private void HandleCellSet(byte[] gridData, int x, int z)
        {
            // For bulk operations, set entire grid
            if (gridData != null)
            {
                SetGridBytes(gridData);
            }
        ...
        /// <summary>
        /// Handle clear request from EventHandler.
        /// </summary>
        private void HandleCleared()
        {
            Debug.Log("[ComputeGridEngine] Clear requested via event");
            ClearGrid();
        }
