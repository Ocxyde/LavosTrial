...
//
// ️  OBSOLETE - Replaced by CompleteMazeBuilder + MazeBuilderEditor
// USAGE (NEW):
...
{
    [System.Obsolete("QuickSceneSetup is deprecated. Use CompleteMazeBuilder with MazeBuilderEditor (Tools → Maze → Generate Maze) instead. This file will be deleted by cleanup_obsolete_editor_scripts.ps1")]
    public class QuickSceneSetup
    {
        ...
        public static void GenerateCompleteScene()
        {
            ...
            Debug.Log("    • FpsMazeTest (test controller - handles ground/ceiling)");
            Debug.Log("");
        ...
        private static void ConfigureComponents(GameObject mazeTest)
        {
            ...
            if (fpsMazeTest != null)
            {
                ...
                SetField(fpsMazeTest, "mazeWidth", 21);  //  Reduced from 31
                SetField(fpsMazeTest, "mazeHeight", 21);  //  Reduced from 31
